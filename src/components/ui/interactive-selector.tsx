...
const InteractiveSelector = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-[#111] font-sans text-white w-full py-16"> 
      {/* Header Section */}
      <div className="w-full max-w-2xl px-6 mb-2 text-center z-10">
        <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-lg animate-fadeInTop delay-300">Why Choose Us ?</h1>
      ...
      {/* Options Container */}
      <div className="options flex w-full max-w-[900px] min-w-[320px] md:min-w-[600px] h-[450px] md:h-[400px] mx-0 items-stretch overflow-hidden relative px-4">
